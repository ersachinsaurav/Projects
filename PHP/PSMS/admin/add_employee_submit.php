...
{	
	...
	$sql = "INSERT INTO employee(emp_name, mname, fname, sname, dob, emp_add, category, designation, marital_sts, mob1, mob2, email, gender, salary, grade, doa, department) VALUES ('$emp_name', '$mname', '$fname', '$sname', '$dob', '$emp_add', '$category', '$designation', '$marital_sts', '$mob1', '$mob2', '$email', '$gender', '$salary', '$grade', '$doa', '$department')";
